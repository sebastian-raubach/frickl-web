  ...
  <b-container class="mt-3">
    <b-row>
      ...
      <b-col cols=8 class="text-center">
        <img fluid src="../assets/frickl.svg" alt="Frickl logo" />
      </b-col>
      <b-col cols=2></b-col>
    </b-row>
    <h1>About Frickl</h1>
    ...
    <p>It has been written, designed and developed by <a href="mailto:sebastian@raubach.co.uk">Sebastian Raubach</a>.</p>
      ...
      <b-col xs=12 sm=6 lg=4 class="mb-3">
        <b-card no-body>
          ...
          <b-card-footer class="text-center">
            <a href="https://github.com/sebastian-raubach/frickl-web">Frickl on Github</a>
          </b-card-footer>
        </b-card>
      </b-col>
      <b-col xs=12 sm=6 lg=4 class="mb-3">
        <b-card no-body>
          <div class="card-img text-center">
            <DockerIcon class="docker"/>
          </div>
          <b-card-footer class="text-center">
            <a href="#">Frickl Docker Container</a>
          </b-card-footer>
        </b-card>
      </b-col>
      <b-col xs=12 sm=6 lg=4 class="mb-3">
...
<style>
  .about-links .material-design-icon {
    height: 10em;
    width: 10em;
  }
  .about-links .material-design-icon > .material-design-icon__svg {
      height: 10em;
      width: 10em;
  }
  .about-links .docker .material-design-icon__svg {
    fill: #0db7ed;
  }
  .about-links .github .material-design-icon__svg {
    fill: #333;
  }
</style>
