    ...
    <b-row class="about-links">
      <b-col xs=12 sm=6 lg=4 class="mb-3">
        <b-card no-body>
          <div class="card-img text-center">
            <img src="../assets/github.svg" class="img-fluid p-5" alt="Github" />
          </div>
      ...
      <b-col xs=12 sm=6 lg=4 class="mb-3">
        <b-card no-body>
          ...
          <b-card-footer class="text-center">
            <a href="https://github.com/sebastian-raubach/frickl-web/tree/master/docker">Frickl Docker Container</a>
          </b-card-footer>
        </b-card>
      </b-col>
      <b-col xs=12 sm=6 lg=4 class="mb-3">
