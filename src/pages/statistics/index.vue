<template>
  <v-container>
    ...
    <ImageHeatmapChart :chart-data="chartData" v-if="chartData && chartData.length > 0" @date-selected="setDate" />
    ...
    <template v-if="selectedDate">
      ...
      <v-divider class="mb-3" />
      <ImageGallery :get-data="getImages" ref="imageGallery" />
    </template>
  </v-container>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getImages: function (params) {
        const adjusted = this.selectedDate ? Object.assign({}, params, { date: this.selectedDate.toISOString().slice(0, 10) }) : params
